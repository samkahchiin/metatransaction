...
describe("MetaTokenTransfer", function () {
  it("Should let user transfer tokens through a relayer with different nonces", async function () {
    ...
    // STEP 0: Have user infinite approve the token sender contract for transferring 'RandomToken'
    ...
    // STEP 1: Have user sign message to approve transaction (eg. exchange, burn)
    ...
    // STEP 2: App serve as the relayer and perform the transactions
