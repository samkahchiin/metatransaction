...
describe("MetaTokenTransfer", function () {
  it("Should let user transfer tokens through a relayer", async function () {
    ...
    // STEP 1: Require approval from user => SIGN Message
    ...
    // STEP 2: Execute the transaction at the BE
    ...
    await metaTxn.wait();
    // STEP 3: Waiting for the transaction performed and return response to FE
